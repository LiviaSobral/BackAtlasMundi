...
router.post('/country', controller.findByCountry.bind(controller)) //busca todos os commentarios por pais, recebe id do pais
router.post('/user', controller.findByUser.bind(controller)) //busca todos os commentarios de um usuario em especifico, recebe id do usuario
router.post('/id', controller.findById.bind(controller)) //busca um commentario por seu ID
